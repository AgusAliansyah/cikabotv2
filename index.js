...
const ovo = '089613469459';
const pulsa = '089613469459';
const dana = '089613469459';
const BotName = 'CikaBot'; 
const instagram = 'http://www.instagram.com/agus_aliansyah/'; 
const aktif = '08:00 - 22:00';
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n' 
            + 'FN:CikaBot\n' // Nama kamu
            + 'ORG:OWNER CikaBot;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=628956032-72884:+62 895-6032-72884\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Scan kode qr dengan whatsapp bot by @VARGAS_250!`);
});
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @VARGAS_250`)
})
...
conn.sendMessage(id, '.........',MessageType.text, { quoted: m } );
}
 //intro grup
